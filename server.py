...
prepare_tardoc_abrechnung_func: PrepareTardocAbrechnungType = lambda r, l, lang_param='de': {"type": "Error", "message": "TARDOC Prep Fallback (LKN Funktion fehlt)"}
...
def analyze_billing():
    ...
    final_response_payload = {
        ...
        "evaluated_pauschalen": finale_abrechnung_obj.get("evaluated_pauschalen", []) if finale_abrechnung_obj else []
    }
